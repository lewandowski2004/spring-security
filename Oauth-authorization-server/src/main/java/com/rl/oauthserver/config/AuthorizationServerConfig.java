...
/*    @Bean
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient registeredClient_2 = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("api-client_2")
                .clientSecret(passwordEncoder().encode("secret_2"))
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
                .redirectUri("http://127.0.0.1:8070/login/oauth2/code/api-client_2-oidc")
        ...
        return new InMemoryRegisteredClientRepository(List.of(registeredClient, registeredClient_2));
    }
